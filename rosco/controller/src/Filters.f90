...
!-------------------------------------------------------------------------------------------------------------------------------
    ...
    ! Prefilter shared measured wind turbine signals
        ...
        LocalVar%NacIMU_FA_AccFTq = SecLPFilter(LocalVar%NacIMU_FA_RAcc, LocalVar%DT, CntrPar%F_FlTqCornerFreq(1), CntrPar%F_FlTqCornerFreq(2), LocalVar%FP, LocalVar%iStatus, LocalVar%restart, objInst%instSecLPF) ! Fixed Damping
        LocalVar%FA_AccFTq = SecLPFilter(LocalVar%FA_Acc_Nac, LocalVar%DT, CntrPar%F_FlTqCornerFreq(1), CntrPar%F_FlTqCornerFreq(2), LocalVar%FP, LocalVar%iStatus, LocalVar%restart, objInst%instSecLPF) ! Fixed Damping
        ...
        LocalVar%NacIMU_FA_AccFTq = HPFilter(LocalVar%NacIMU_FA_AccFTq, LocalVar%DT, CntrPar%F_FlHighPassFreq, LocalVar%FP, LocalVar%iStatus, LocalVar%restart, objInst%instHPF)
        LocalVar%FA_AccFTq = HPFilter(LocalVar%FA_AccFTq, LocalVar%DT, CntrPar%F_FlHighPassFreq, LocalVar%FP, LocalVar%iStatus, LocalVar%restart, objInst%instHPF)
