...
TYPE, PUBLIC :: ControlParameters
    ...
    REAL(DbKi)                    :: ASO_WindGain                ! AEPS design parameter for effective avoidance
    REAL(DbKi)                    :: ASO_ThrustGain              ! BEPS design parameter for effective avoidance
    REAL(DbKi)                    :: ASO_StartTime               ! AEPS/BEPS activation time for avoidance
