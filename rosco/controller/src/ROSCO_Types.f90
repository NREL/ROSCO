...
TYPE, PUBLIC :: LocalVariables
    ...
    REAL(DbKi)                    :: Thrst                       ! Turbine Thrust Force [MN]
    REAL(DbKi)                    :: Thrst_nofilt                ! Turbine Thrust Force [MN]
    REAL(DbKi)                    :: ThrstN                      ! Turbine Thrust Force [N]
    REAL(DbKi)                    :: Thrst_es                    ! Estimated Turbine Thrust Force by Adaptive EPS System [MN]
    ...
    REAL(DbKi)                    :: Uenv_nofilt                 ! No Filtered Envelope Wind Speed [m/s]
    REAL(DbKi)                    :: Delta                       ! Delta
    REAL(DbKi)                    :: dp                          ! reducing design parameter
    LOGICAL                       :: dpinitdone                  ! reducing design parameter
    REAL(DbKi)                    :: Del_Beta_NRL                ! Extra Blade Pitch Angle with Rate Limiter, an Avoidance Signal generated by Adaptive EPS System
    REAL(DbKi)                    :: Del_Beta                    ! Extra Blade Pitch Angle, an Avoidance Signal generated by Adaptive EPS System
    REAL(DbKi)                    :: Pavo_sig                    ! Extra Blade Pitch Angle, an Avoidance Signal generated by Adaptive EPS System
    ...
    REAL(DbKi)                    :: PC_PitComT_NLP              ! Not Filtered Collective pitch commmand from PI control [rad].
