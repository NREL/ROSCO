! ROSCO IO
! This file is automatically generated by write_registry.py using ROSCO v2.9.5
...
! Debug routine, defines what gets printed to DEBUG.dbg if LoggingLevel = 1
    ...
    CHARACTER(15), DIMENSION(156)      :: LocalVarOutStrings
    ...
    LocalVarOutData(113) = LocalVar%SD_MaxPitchRate
    LocalVarOutData(114) = LocalVar%SD_MaxTorqueRate
    LocalVarOutData(115) = LocalVar%GenTq_SD
    LocalVarOutData(116) = LocalVar%Fl_PitCom
    LocalVarOutData(117) = LocalVar%NACIMU_FA_AccF
    LocalVarOutData(118) = LocalVar%FA_AccF
    LocalVarOutData(119) = LocalVar%FA_Hist
    LocalVarOutData(120) = LocalVar%TRA_LastRefSpd
    LocalVarOutData(121) = LocalVar%VS_RefSpeed
    LocalVarOutData(122) = LocalVar%PtfmTDX
    LocalVarOutData(123) = LocalVar%PtfmTDY
    LocalVarOutData(124) = LocalVar%PtfmTDZ
    LocalVarOutData(125) = LocalVar%PtfmRDX
    LocalVarOutData(126) = LocalVar%PtfmRDY
    LocalVarOutData(127) = LocalVar%PtfmRDZ
    LocalVarOutData(128) = LocalVar%PtfmTVX
    LocalVarOutData(129) = LocalVar%PtfmTVY
    LocalVarOutData(130) = LocalVar%PtfmTVZ
    LocalVarOutData(131) = LocalVar%PtfmRVX
    LocalVarOutData(132) = LocalVar%PtfmRVY
    LocalVarOutData(133) = LocalVar%PtfmRVZ
    LocalVarOutData(134) = LocalVar%PtfmTAX
    LocalVarOutData(135) = LocalVar%PtfmTAY
    LocalVarOutData(136) = LocalVar%PtfmTAZ
    LocalVarOutData(137) = LocalVar%PtfmRAX
    LocalVarOutData(138) = LocalVar%PtfmRAY
    LocalVarOutData(139) = LocalVar%PtfmRAZ
    LocalVarOutData(140) = LocalVar%CC_DesiredL(1)
    LocalVarOutData(141) = LocalVar%CC_ActuatedL(1)
    LocalVarOutData(142) = LocalVar%CC_ActuatedDL(1)
    LocalVarOutData(143) = LocalVar%StC_Input(1)
    LocalVarOutData(144) = LocalVar%Flp_Angle(1)
    LocalVarOutData(145) = LocalVar%RootMyb_Last(1)
    LocalVarOutData(146) = LocalVar%ACC_INFILE_SIZE
    LocalVarOutData(147) = LocalVar%AWC_complexangle(1)
    LocalVarOutData(148) = LocalVar%TiltMean
    LocalVarOutData(149) = LocalVar%YawMean
    LocalVarOutData(150) = LocalVar%ZMQ_ID
    LocalVarOutData(151) = LocalVar%ZMQ_YawOffset
    LocalVarOutData(152) = LocalVar%ZMQ_TorqueOffset
    LocalVarOutData(153) = LocalVar%ZMQ_PitOffset(1)
    LocalVarOutData(154) = LocalVar%ZMQ_R_Speed
    LocalVarOutData(155) = LocalVar%ZMQ_R_Torque
    LocalVarOutData(156) = LocalVar%ZMQ_R_Pitch
    ...
    LocalVarOutStrings(113) = 'SD_MaxPitchRate'
    LocalVarOutStrings(114) = 'SD_MaxTorqueRate'
    LocalVarOutStrings(115) = 'GenTq_SD'
    LocalVarOutStrings(116) = 'Fl_PitCom'
    LocalVarOutStrings(117) = 'NACIMU_FA_AccF'
    LocalVarOutStrings(118) = 'FA_AccF'
    LocalVarOutStrings(119) = 'FA_Hist'
    LocalVarOutStrings(120) = 'TRA_LastRefSpd'
    LocalVarOutStrings(121) = 'VS_RefSpeed'
    LocalVarOutStrings(122) = 'PtfmTDX'
    LocalVarOutStrings(123) = 'PtfmTDY'
    LocalVarOutStrings(124) = 'PtfmTDZ'
    LocalVarOutStrings(125) = 'PtfmRDX'
    LocalVarOutStrings(126) = 'PtfmRDY'
    LocalVarOutStrings(127) = 'PtfmRDZ'
    LocalVarOutStrings(128) = 'PtfmTVX'
    LocalVarOutStrings(129) = 'PtfmTVY'
    LocalVarOutStrings(130) = 'PtfmTVZ'
    LocalVarOutStrings(131) = 'PtfmRVX'
    LocalVarOutStrings(132) = 'PtfmRVY'
    LocalVarOutStrings(133) = 'PtfmRVZ'
    LocalVarOutStrings(134) = 'PtfmTAX'
    LocalVarOutStrings(135) = 'PtfmTAY'
    LocalVarOutStrings(136) = 'PtfmTAZ'
    LocalVarOutStrings(137) = 'PtfmRAX'
    LocalVarOutStrings(138) = 'PtfmRAY'
    LocalVarOutStrings(139) = 'PtfmRAZ'
    LocalVarOutStrings(140) = 'CC_DesiredL'
    LocalVarOutStrings(141) = 'CC_ActuatedL'
    LocalVarOutStrings(142) = 'CC_ActuatedDL'
    LocalVarOutStrings(143) = 'StC_Input'
    LocalVarOutStrings(144) = 'Flp_Angle'
    LocalVarOutStrings(145) = 'RootMyb_Last'
    LocalVarOutStrings(146) = 'ACC_INFILE_SIZE'
    LocalVarOutStrings(147) = 'AWC_complexangle'
    LocalVarOutStrings(148) = 'TiltMean'
    LocalVarOutStrings(149) = 'YawMean'
    LocalVarOutStrings(150) = 'ZMQ_ID'
    LocalVarOutStrings(151) = 'ZMQ_YawOffset'
    LocalVarOutStrings(152) = 'ZMQ_TorqueOffset'
    LocalVarOutStrings(153) = 'ZMQ_PitOffset'
    LocalVarOutStrings(154) = 'ZMQ_R_Speed'
    LocalVarOutStrings(155) = 'ZMQ_R_Torque'
    LocalVarOutStrings(156) = 'ZMQ_R_Pitch'
    ...
    IF ((LocalVar%iStatus == 0) .OR. (LocalVar%iStatus == -9))  THEN ! .TRUE. if we're on the first call to the DLL
        ...
        IF (CntrPar%LoggingLevel > 1) THEN
            ...
            WRITE(UnDb2, '(157(a20,TR5:))') 'Time',   LocalVarOutStrings
            WRITE(UnDb2, '(157(a20,TR5:))')
        END IF
    ...
    ! Write debug files
    FmtDat = "(F20.5,TR5,156(ES20.5E2,TR5:))"   ! The format of the debugging data
