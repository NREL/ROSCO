...
! Debug routine, defines what gets printed to DEBUG.dbg if LoggingLevel = 1
    ...
    LocalVarOutData(49) = LocalVar%IPC_PitComF(1)
    ...
    LocalVarOutData(58) = LocalVar%PC_PitComTF
    LocalVarOutData(59) = LocalVar%PC_PitComT_IPC(1)
    ...
    LocalVarOutData(72) = LocalVar%IPC_KI(1)
    LocalVarOutData(73) = LocalVar%IPC_KP(1)
    LocalVarOutData(74) = LocalVar%IPC_IntSat
    LocalVarOutData(75) = LocalVar%PC_State
    LocalVarOutData(76) = LocalVar%PitCom(1)
    LocalVarOutData(77) = LocalVar%PitCom_SD(1)
    LocalVarOutData(78) = LocalVar%PitComAct(1)
    ...
    LocalVarOutStrings(34) = 'VS_RefSpd'
    LocalVarOutStrings(35) = 'VS_RefSpd_TSR'
    LocalVarOutStrings(36) = 'VS_RefSpd_TRA'
    LocalVarOutStrings(37) = 'VS_RefSpd_RL'
    LocalVarOutStrings(38) = 'PC_RefSpd'
    LocalVarOutStrings(39) = 'PC_RefSpd_SS'
    LocalVarOutStrings(40) = 'PC_RefSpd_PRC'
    LocalVarOutStrings(41) = 'RotSpeedF'
    LocalVarOutStrings(42) = 'GenSpeedF'
    LocalVarOutStrings(43) = 'GenTq'
    LocalVarOutStrings(44) = 'GenTqMeas'
    LocalVarOutStrings(45) = 'GenArTq'
    LocalVarOutStrings(46) = 'GenBrTq'
    LocalVarOutStrings(47) = 'VS_KOmega2_GenTq'
    LocalVarOutStrings(48) = 'VS_ConstPwr_GenTq'
    LocalVarOutStrings(49) = 'IPC_PitComF'
    LocalVarOutStrings(50) = 'PC_KP'
    LocalVarOutStrings(51) = 'PC_KI'
    LocalVarOutStrings(52) = 'PC_KD'
    LocalVarOutStrings(53) = 'PC_TF'
    LocalVarOutStrings(54) = 'PC_MaxPit'
    LocalVarOutStrings(55) = 'PC_MinPit'
    LocalVarOutStrings(56) = 'PC_PitComT'
    LocalVarOutStrings(57) = 'PC_PitComT_Last'
    LocalVarOutStrings(58) = 'PC_PitComTF'
    LocalVarOutStrings(59) = 'PC_PitComT_IPC'
    LocalVarOutStrings(60) = 'PC_PwrErr'
    LocalVarOutStrings(61) = 'PC_SpdErr'
    LocalVarOutStrings(62) = 'IPC_AxisTilt_1P'
    LocalVarOutStrings(63) = 'IPC_AxisYaw_1P'
    LocalVarOutStrings(64) = 'IPC_AxisTilt_2P'
    LocalVarOutStrings(65) = 'IPC_AxisYaw_2P'
    LocalVarOutStrings(66) = 'axisTilt_1P'
    LocalVarOutStrings(67) = 'axisYaw_1P'
    LocalVarOutStrings(68) = 'axisYawF_1P'
    LocalVarOutStrings(69) = 'axisTilt_2P'
    LocalVarOutStrings(70) = 'axisYaw_2P'
    LocalVarOutStrings(71) = 'axisYawF_2P'
    LocalVarOutStrings(72) = 'IPC_KI'
    LocalVarOutStrings(73) = 'IPC_KP'
    LocalVarOutStrings(74) = 'IPC_IntSat'
    LocalVarOutStrings(75) = 'PC_State'
    LocalVarOutStrings(76) = 'PitCom'
    LocalVarOutStrings(77) = 'PitCom_SD'
    LocalVarOutStrings(78) = 'PitComAct'
    LocalVarOutStrings(79) = 'SS_DelOmegaF'
    LocalVarOutStrings(80) = 'TestType'
    LocalVarOutStrings(81) = 'Kp_Float'
    LocalVarOutStrings(82) = 'VS_MaxTq'
    LocalVarOutStrings(83) = 'VS_LastGenTrq'
    LocalVarOutStrings(84) = 'VS_LastGenPwr'
    LocalVarOutStrings(85) = 'VS_MechGenPwr'
    LocalVarOutStrings(86) = 'VS_SpdErrAr'
    LocalVarOutStrings(87) = 'VS_SpdErrBr'
    LocalVarOutStrings(88) = 'VS_SpdErr'
    LocalVarOutStrings(89) = 'VS_State'
    LocalVarOutStrings(90) = 'VS_Rgn3Pitch'
    LocalVarOutStrings(91) = 'WE_Vw'
    LocalVarOutStrings(92) = 'WE_Vw_F'
    LocalVarOutStrings(93) = 'WE_VwI'
    LocalVarOutStrings(94) = 'WE_VwIdot'
    LocalVarOutStrings(95) = 'WE_Op'
    LocalVarOutStrings(96) = 'WE_Op_Last'
    LocalVarOutStrings(97) = 'VS_LastGenTrqF'
    LocalVarOutStrings(98) = 'PRC_WSE_F'
    LocalVarOutStrings(99) = 'PRC_R_Speed'
    LocalVarOutStrings(100) = 'PRC_R_Torque'
    LocalVarOutStrings(101) = 'PRC_R_Pitch'
    LocalVarOutStrings(102) = 'PRC_R_Total'
    LocalVarOutStrings(103) = 'PRC_Min_Pitch'
    LocalVarOutStrings(104) = 'PS_Min_Pitch'
    LocalVarOutStrings(105) = 'OL_Index'
    LocalVarOutStrings(106) = 'SU_Stage'
    LocalVarOutStrings(107) = 'SU_LoadStageStartTime'
    LocalVarOutStrings(108) = 'SU_RotSpeedF'
    LocalVarOutStrings(109) = 'SD_Trigger'
    LocalVarOutStrings(110) = 'SD_BlPitchF'
    LocalVarOutStrings(111) = 'SD_NacVaneF'
    LocalVarOutStrings(112) = 'SD_GenSpeedF'
