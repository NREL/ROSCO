...
! Debug routine, defines what gets printed to DEBUG.dbg if LoggingLevel = 1
    ...
    LocalVarOutData(74) = LocalVar%VS_MaxTq
    LocalVarOutData(75) = LocalVar%VS_LastGenTrq
    LocalVarOutData(76) = LocalVar%VS_LastGenPwr
    LocalVarOutData(77) = LocalVar%VS_MechGenPwr
    LocalVarOutData(78) = LocalVar%VS_SpdErrAr
    LocalVarOutData(79) = LocalVar%VS_SpdErrBr
    LocalVarOutData(80) = LocalVar%VS_SpdErr
    LocalVarOutData(81) = LocalVar%VS_State
    LocalVarOutData(82) = LocalVar%VS_Rgn3Pitch
    LocalVarOutData(83) = LocalVar%WE_Vw
    LocalVarOutData(84) = LocalVar%WE_Vw_F
    LocalVarOutData(85) = LocalVar%WE_VwI
    LocalVarOutData(86) = LocalVar%WE_VwIdot
    LocalVarOutData(87) = LocalVar%VS_LastGenTrqF
    LocalVarOutData(88) = LocalVar%PRC_WSE_F
    LocalVarOutData(89) = LocalVar%PRC_R_Speed
    LocalVarOutData(90) = LocalVar%PRC_R_Torque
    LocalVarOutData(91) = LocalVar%PRC_R_Pitch
    LocalVarOutData(92) = LocalVar%PRC_R_Total
    LocalVarOutData(93) = LocalVar%PRC_Min_Pitch
    LocalVarOutData(94) = LocalVar%PS_Min_Pitch
    LocalVarOutData(95) = LocalVar%OL_Index
    LocalVarOutData(96) = LocalVar%Fl_PitCom
    LocalVarOutData(97) = LocalVar%NACIMU_FA_AccF
    LocalVarOutData(98) = LocalVar%FA_AccF
    LocalVarOutData(99) = LocalVar%FA_Hist
    LocalVarOutData(100) = LocalVar%TRA_LastRefSpd
    LocalVarOutData(101) = LocalVar%VS_RefSpeed
    LocalVarOutData(102) = LocalVar%PtfmTDX
    LocalVarOutData(103) = LocalVar%PtfmTDY
    LocalVarOutData(104) = LocalVar%PtfmTDZ
    LocalVarOutData(105) = LocalVar%PtfmRDX
    LocalVarOutData(106) = LocalVar%PtfmRDY
    LocalVarOutData(107) = LocalVar%PtfmRDZ
    LocalVarOutData(108) = LocalVar%PtfmTVX
    LocalVarOutData(109) = LocalVar%PtfmTVY
    LocalVarOutData(110) = LocalVar%PtfmTVZ
    LocalVarOutData(111) = LocalVar%PtfmRVX
    LocalVarOutData(112) = LocalVar%PtfmRVY
    LocalVarOutData(113) = LocalVar%PtfmRVZ
    LocalVarOutData(114) = LocalVar%PtfmTAX
    LocalVarOutData(115) = LocalVar%PtfmTAY
    LocalVarOutData(116) = LocalVar%PtfmTAZ
    LocalVarOutData(117) = LocalVar%PtfmRAX
    LocalVarOutData(118) = LocalVar%PtfmRAY
    LocalVarOutData(119) = LocalVar%PtfmRAZ
    LocalVarOutData(120) = LocalVar%CC_DesiredL(1)
    LocalVarOutData(121) = LocalVar%CC_ActuatedL(1)
    LocalVarOutData(122) = LocalVar%CC_ActuatedDL(1)
    LocalVarOutData(123) = LocalVar%StC_Input(1)
    LocalVarOutData(124) = LocalVar%Flp_Angle(1)
    LocalVarOutData(125) = LocalVar%RootMyb_Last(1)
    LocalVarOutData(126) = LocalVar%ACC_INFILE_SIZE
    LocalVarOutData(127) = LocalVar%AWC_complexangle(1)
    LocalVarOutData(128) = LocalVar%ZMQ_ID
    LocalVarOutData(129) = LocalVar%ZMQ_YawOffset
    LocalVarOutData(130) = LocalVar%ZMQ_TorqueOffset
    LocalVarOutData(131) = LocalVar%ZMQ_PitOffset(1)
    LocalVarOutData(132) = LocalVar%ZMQ_R_Speed
    LocalVarOutData(133) = LocalVar%ZMQ_R_Torque
    LocalVarOutData(134) = LocalVar%ZMQ_R_Pitch
    LocalVarOutStrings = [CHARACTER(15) ::  'iStatus', 'Time', 'DT', 'n_DT', 'Time_Last', & 
                                      ...
                                      'WE_VwIdot', 'VS_LastGenTrqF', 'PRC_WSE_F', 'PRC_R_Speed', 'PRC_R_Torque', & 
                                      'PRC_R_Pitch', 'PRC_R_Total', 'PRC_Min_Pitch', 'PS_Min_Pitch', 'OL_Index', & 
                                      'Fl_PitCom', 'NACIMU_FA_AccF', 'FA_AccF', 'FA_Hist', 'TRA_LastRefSpd', & 
    ...
    IF ((LocalVar%iStatus == 0) .OR. (LocalVar%iStatus == -9))  THEN ! .TRUE. if we're on the first call to the DLL
        ...
        IF (CntrPar%LoggingLevel > 1) THEN
            ...
            WRITE(UnDb2, '(135(a20,TR5:))') 'Time',   LocalVarOutStrings
            WRITE(UnDb2, '(135(a20,TR5:))')
        END IF
    ...
    ! Write debug files
    FmtDat = "(F20.5,TR5,134(ES20.5E2,TR5:))"   ! The format of the debugging data
