...
SUBROUTINE WriteRestartFile(LocalVar, CntrPar, ErrVar, objInst, RootName, size_avcOUTNAME)
    ...
    ELSE
        ...
        WRITE( Un, IOSTAT=ErrStat) LocalVar%Adp
        ...
        WRITE( Un, IOSTAT=ErrStat) LocalVar%PC_PitComT_NLP
...
SUBROUTINE ReadRestartFile(avrSWAP, LocalVar, CntrPar, objInst, PerfData, RootName, size_avcOUTNAME, ErrVar)
    ...
    ELSE
        ...
        READ( Un, IOSTAT=ErrStat) LocalVar%Adp
        ...
        READ( Un, IOSTAT=ErrStat) LocalVar%PC_PitComT_NLP
...
! Debug routine, defines what gets printed to DEBUG.dbg if LoggingLevel = 1
    ...
    CHARACTER(15), DIMENSION(171)      :: LocalVarOutStrings
    ...
    LocalVarOutData(25) = LocalVar%Adp
    ...
    LocalVarOutData(33) = LocalVar%OL_Azimuth
    LocalVarOutData(34) = LocalVar%AzUnwrapped
    LocalVarOutData(35) = LocalVar%AzError
    LocalVarOutData(36) = LocalVar%GenTqAz
    LocalVarOutData(37) = LocalVar%AzBuffer(1)
    LocalVarOutData(38) = LocalVar%NumBl
    LocalVarOutData(39) = LocalVar%FA_Acc_TT
    LocalVarOutData(40) = LocalVar%SS_Acc_TT
    LocalVarOutData(41) = LocalVar%FA_Acc_Nac
    LocalVarOutData(42) = LocalVar%NacIMU_FA_RAcc
    LocalVarOutData(43) = LocalVar%FA_AccHPF
    LocalVarOutData(44) = LocalVar%FA_AccHPFI
    LocalVarOutData(45) = LocalVar%FA_PitCom(1)
    LocalVarOutData(46) = LocalVar%VS_RefSpd
    LocalVarOutData(47) = LocalVar%VS_RefSpd_TSR
    LocalVarOutData(48) = LocalVar%VS_RefSpd_TRA
    LocalVarOutData(49) = LocalVar%VS_RefSpd_RL
    LocalVarOutData(50) = LocalVar%PC_RefSpd
    LocalVarOutData(51) = LocalVar%PC_RefSpd_SS
    LocalVarOutData(52) = LocalVar%PC_RefSpd_PRC
    LocalVarOutData(53) = LocalVar%RotSpeedF
    LocalVarOutData(54) = LocalVar%GenSpeedF
    LocalVarOutData(55) = LocalVar%GenTq
    LocalVarOutData(56) = LocalVar%GenTqMeas
    LocalVarOutData(57) = LocalVar%GenArTq
    LocalVarOutData(58) = LocalVar%GenBrTq
    LocalVarOutData(59) = LocalVar%VS_KOmega2_GenTq
    LocalVarOutData(60) = LocalVar%VS_ConstPwr_GenTq
    LocalVarOutData(61) = LocalVar%IPC_PitComF(1)
    LocalVarOutData(62) = LocalVar%PC_KP
    LocalVarOutData(63) = LocalVar%PC_KI
    LocalVarOutData(64) = LocalVar%PC_KD
    LocalVarOutData(65) = LocalVar%PC_TF
    LocalVarOutData(66) = LocalVar%PC_MaxPit
    LocalVarOutData(67) = LocalVar%PC_MinPit
    LocalVarOutData(68) = LocalVar%PC_PitComT_NLP
    LocalVarOutData(69) = LocalVar%PC_PitComT
    LocalVarOutData(70) = LocalVar%PC_PitComT_Last
    LocalVarOutData(71) = LocalVar%BlPitchCMeasF
    LocalVarOutData(72) = LocalVar%PC_PitComT_IPC(1)
    LocalVarOutData(73) = LocalVar%PC_PwrErr
    LocalVarOutData(74) = LocalVar%PC_SpdErr
    LocalVarOutData(75) = LocalVar%IPC_AxisTilt_1P
    LocalVarOutData(76) = LocalVar%IPC_AxisYaw_1P
    LocalVarOutData(77) = LocalVar%IPC_AxisTilt_2P
    LocalVarOutData(78) = LocalVar%IPC_AxisYaw_2P
    LocalVarOutData(79) = LocalVar%axisTilt_1P
    LocalVarOutData(80) = LocalVar%axisYaw_1P
    LocalVarOutData(81) = LocalVar%axisYawF_1P
    LocalVarOutData(82) = LocalVar%axisTilt_2P
    LocalVarOutData(83) = LocalVar%axisYaw_2P
    LocalVarOutData(84) = LocalVar%axisYawF_2P
    LocalVarOutData(85) = LocalVar%IPC_KI(1)
    LocalVarOutData(86) = LocalVar%IPC_KP(1)
    LocalVarOutData(87) = LocalVar%IPC_IntSat
    LocalVarOutData(88) = LocalVar%PC_State
    LocalVarOutData(89) = LocalVar%PitCom(1)
    LocalVarOutData(90) = LocalVar%PitCom_SD(1)
    LocalVarOutData(91) = LocalVar%PitComAct(1)
    LocalVarOutData(92) = LocalVar%SS_DelOmegaF
    LocalVarOutData(93) = LocalVar%TestType
    LocalVarOutData(94) = LocalVar%Kp_Float
    LocalVarOutData(95) = LocalVar%VS_MaxTq
    LocalVarOutData(96) = LocalVar%VS_LastGenTrq
    LocalVarOutData(97) = LocalVar%VS_LastGenPwr
    LocalVarOutData(98) = LocalVar%VS_MechGenPwr
    LocalVarOutData(99) = LocalVar%VS_SpdErrAr
    LocalVarOutData(100) = LocalVar%VS_SpdErrBr
    LocalVarOutData(101) = LocalVar%VS_SpdErr
    LocalVarOutData(102) = LocalVar%VS_State
    LocalVarOutData(103) = LocalVar%VS_Rgn3Pitch
    LocalVarOutData(104) = LocalVar%WE_Vw
    LocalVarOutData(105) = LocalVar%WE_Vw_F
    LocalVarOutData(106) = LocalVar%WE_VwI
    LocalVarOutData(107) = LocalVar%WE_VwIdot
    LocalVarOutData(108) = LocalVar%WE_Op
    LocalVarOutData(109) = LocalVar%WE_Op_Last
    LocalVarOutData(110) = LocalVar%VS_LastGenTrqF
    LocalVarOutData(111) = LocalVar%PRC_WSE_F
    LocalVarOutData(112) = LocalVar%PRC_R_Speed
    LocalVarOutData(113) = LocalVar%PRC_R_Torque
    LocalVarOutData(114) = LocalVar%PRC_R_Pitch
    LocalVarOutData(115) = LocalVar%PRC_R_Total
    LocalVarOutData(116) = LocalVar%PRC_Min_Pitch
    LocalVarOutData(117) = LocalVar%PS_Min_Pitch
    LocalVarOutData(118) = LocalVar%OL_Index
    LocalVarOutData(119) = LocalVar%SU_Stage
    LocalVarOutData(120) = LocalVar%SU_LoadStageStartTime
    LocalVarOutData(121) = LocalVar%SU_RotSpeedF
    LocalVarOutData(122) = LocalVar%SD_Trigger
    LocalVarOutData(123) = LocalVar%SD_BlPitchF
    LocalVarOutData(124) = LocalVar%SD_NacVaneF
    LocalVarOutData(125) = LocalVar%SD_GenSpeedF
    LocalVarOutData(126) = LocalVar%SD_Stage
    LocalVarOutData(127) = LocalVar%SD_StageStartTime
    LocalVarOutData(128) = LocalVar%SD_MaxPitchRate
    LocalVarOutData(129) = LocalVar%SD_MaxTorqueRate
    LocalVarOutData(130) = LocalVar%GenTq_SD
    LocalVarOutData(131) = LocalVar%Fl_PitCom
    LocalVarOutData(132) = LocalVar%NACIMU_FA_AccF
    LocalVarOutData(133) = LocalVar%FA_AccF
    LocalVarOutData(134) = LocalVar%FA_Hist
    LocalVarOutData(135) = LocalVar%TRA_LastRefSpd
    LocalVarOutData(136) = LocalVar%VS_RefSpeed
    LocalVarOutData(137) = LocalVar%PtfmTDX
    LocalVarOutData(138) = LocalVar%PtfmTDY
    LocalVarOutData(139) = LocalVar%PtfmTDZ
    LocalVarOutData(140) = LocalVar%PtfmRDX
    LocalVarOutData(141) = LocalVar%PtfmRDY
    LocalVarOutData(142) = LocalVar%PtfmRDZ
    LocalVarOutData(143) = LocalVar%PtfmTVX
    LocalVarOutData(144) = LocalVar%PtfmTVY
    LocalVarOutData(145) = LocalVar%PtfmTVZ
    LocalVarOutData(146) = LocalVar%PtfmRVX
    LocalVarOutData(147) = LocalVar%PtfmRVY
    LocalVarOutData(148) = LocalVar%PtfmRVZ
    LocalVarOutData(149) = LocalVar%PtfmTAX
    LocalVarOutData(150) = LocalVar%PtfmTAY
    LocalVarOutData(151) = LocalVar%PtfmTAZ
    LocalVarOutData(152) = LocalVar%PtfmRAX
    LocalVarOutData(153) = LocalVar%PtfmRAY
    LocalVarOutData(154) = LocalVar%PtfmRAZ
    LocalVarOutData(155) = LocalVar%CC_DesiredL(1)
    LocalVarOutData(156) = LocalVar%CC_ActuatedL(1)
    LocalVarOutData(157) = LocalVar%CC_ActuatedDL(1)
    LocalVarOutData(158) = LocalVar%StC_Input(1)
    LocalVarOutData(159) = LocalVar%Flp_Angle(1)
    LocalVarOutData(160) = LocalVar%RootMyb_Last(1)
    LocalVarOutData(161) = LocalVar%ACC_INFILE_SIZE
    LocalVarOutData(162) = LocalVar%AWC_complexangle(1)
    LocalVarOutData(163) = LocalVar%TiltMean
    LocalVarOutData(164) = LocalVar%YawMean
    LocalVarOutData(165) = LocalVar%ZMQ_ID
    LocalVarOutData(166) = LocalVar%ZMQ_YawOffset
    LocalVarOutData(167) = LocalVar%ZMQ_TorqueOffset
    LocalVarOutData(168) = LocalVar%ZMQ_PitOffset(1)
    LocalVarOutData(169) = LocalVar%ZMQ_R_Speed
    LocalVarOutData(170) = LocalVar%ZMQ_R_Torque
    LocalVarOutData(171) = LocalVar%ZMQ_R_Pitch
    ...
    LocalVarOutStrings(33) = 'OL_Azimuth'
    LocalVarOutStrings(34) = 'AzUnwrapped'
    LocalVarOutStrings(35) = 'AzError'
    LocalVarOutStrings(36) = 'GenTqAz'
    LocalVarOutStrings(37) = 'AzBuffer'
    LocalVarOutStrings(38) = 'NumBl'
    LocalVarOutStrings(39) = 'FA_Acc_TT'
    LocalVarOutStrings(40) = 'SS_Acc_TT'
    LocalVarOutStrings(41) = 'FA_Acc_Nac'
    LocalVarOutStrings(42) = 'NacIMU_FA_RAcc'
    LocalVarOutStrings(43) = 'FA_AccHPF'
    LocalVarOutStrings(44) = 'FA_AccHPFI'
    LocalVarOutStrings(45) = 'FA_PitCom'
    LocalVarOutStrings(46) = 'VS_RefSpd'
    LocalVarOutStrings(47) = 'VS_RefSpd_TSR'
    LocalVarOutStrings(48) = 'VS_RefSpd_TRA'
    LocalVarOutStrings(49) = 'VS_RefSpd_RL'
    LocalVarOutStrings(50) = 'PC_RefSpd'
    LocalVarOutStrings(51) = 'PC_RefSpd_SS'
    LocalVarOutStrings(52) = 'PC_RefSpd_PRC'
    LocalVarOutStrings(53) = 'RotSpeedF'
    LocalVarOutStrings(54) = 'GenSpeedF'
    LocalVarOutStrings(55) = 'GenTq'
    LocalVarOutStrings(56) = 'GenTqMeas'
    LocalVarOutStrings(57) = 'GenArTq'
    LocalVarOutStrings(58) = 'GenBrTq'
    LocalVarOutStrings(59) = 'VS_KOmega2_GenTq'
    LocalVarOutStrings(60) = 'VS_ConstPwr_GenTq'
    LocalVarOutStrings(61) = 'IPC_PitComF'
    LocalVarOutStrings(62) = 'PC_KP'
    LocalVarOutStrings(63) = 'PC_KI'
    LocalVarOutStrings(64) = 'PC_KD'
    LocalVarOutStrings(65) = 'PC_TF'
    LocalVarOutStrings(66) = 'PC_MaxPit'
    LocalVarOutStrings(67) = 'PC_MinPit'
    LocalVarOutStrings(68) = 'PC_PitComT_NLP'
    LocalVarOutStrings(69) = 'PC_PitComT'
    LocalVarOutStrings(70) = 'PC_PitComT_Last'
    LocalVarOutStrings(71) = 'BlPitchCMeasF'
    LocalVarOutStrings(72) = 'PC_PitComT_IPC'
    LocalVarOutStrings(73) = 'PC_PwrErr'
    LocalVarOutStrings(74) = 'PC_SpdErr'
    LocalVarOutStrings(75) = 'IPC_AxisTilt_1P'
    LocalVarOutStrings(76) = 'IPC_AxisYaw_1P'
    LocalVarOutStrings(77) = 'IPC_AxisTilt_2P'
    LocalVarOutStrings(78) = 'IPC_AxisYaw_2P'
    LocalVarOutStrings(79) = 'axisTilt_1P'
    LocalVarOutStrings(80) = 'axisYaw_1P'
    LocalVarOutStrings(81) = 'axisYawF_1P'
    LocalVarOutStrings(82) = 'axisTilt_2P'
    LocalVarOutStrings(83) = 'axisYaw_2P'
    LocalVarOutStrings(84) = 'axisYawF_2P'
    LocalVarOutStrings(85) = 'IPC_KI'
    LocalVarOutStrings(86) = 'IPC_KP'
    LocalVarOutStrings(87) = 'IPC_IntSat'
    LocalVarOutStrings(88) = 'PC_State'
    LocalVarOutStrings(89) = 'PitCom'
    LocalVarOutStrings(90) = 'PitCom_SD'
    LocalVarOutStrings(91) = 'PitComAct'
    LocalVarOutStrings(92) = 'SS_DelOmegaF'
    LocalVarOutStrings(93) = 'TestType'
    LocalVarOutStrings(94) = 'Kp_Float'
    LocalVarOutStrings(95) = 'VS_MaxTq'
    LocalVarOutStrings(96) = 'VS_LastGenTrq'
    LocalVarOutStrings(97) = 'VS_LastGenPwr'
    LocalVarOutStrings(98) = 'VS_MechGenPwr'
    LocalVarOutStrings(99) = 'VS_SpdErrAr'
    LocalVarOutStrings(100) = 'VS_SpdErrBr'
    LocalVarOutStrings(101) = 'VS_SpdErr'
    LocalVarOutStrings(102) = 'VS_State'
    LocalVarOutStrings(103) = 'VS_Rgn3Pitch'
    LocalVarOutStrings(104) = 'WE_Vw'
    LocalVarOutStrings(105) = 'WE_Vw_F'
    LocalVarOutStrings(106) = 'WE_VwI'
    LocalVarOutStrings(107) = 'WE_VwIdot'
    LocalVarOutStrings(108) = 'WE_Op'
    LocalVarOutStrings(109) = 'WE_Op_Last'
    LocalVarOutStrings(110) = 'VS_LastGenTrqF'
    LocalVarOutStrings(111) = 'PRC_WSE_F'
    LocalVarOutStrings(112) = 'PRC_R_Speed'
    LocalVarOutStrings(113) = 'PRC_R_Torque'
    LocalVarOutStrings(114) = 'PRC_R_Pitch'
    LocalVarOutStrings(115) = 'PRC_R_Total'
    LocalVarOutStrings(116) = 'PRC_Min_Pitch'
    LocalVarOutStrings(117) = 'PS_Min_Pitch'
    LocalVarOutStrings(118) = 'OL_Index'
    LocalVarOutStrings(119) = 'SU_Stage'
    LocalVarOutStrings(120) = 'SU_LoadStageStartTime'
    LocalVarOutStrings(121) = 'SU_RotSpeedF'
    LocalVarOutStrings(122) = 'SD_Trigger'
    LocalVarOutStrings(123) = 'SD_BlPitchF'
    LocalVarOutStrings(124) = 'SD_NacVaneF'
    LocalVarOutStrings(125) = 'SD_GenSpeedF'
    LocalVarOutStrings(126) = 'SD_Stage'
    LocalVarOutStrings(127) = 'SD_StageStartTime'
    LocalVarOutStrings(128) = 'SD_MaxPitchRate'
    LocalVarOutStrings(129) = 'SD_MaxTorqueRate'
    LocalVarOutStrings(130) = 'GenTq_SD'
    LocalVarOutStrings(131) = 'Fl_PitCom'
    LocalVarOutStrings(132) = 'NACIMU_FA_AccF'
    LocalVarOutStrings(133) = 'FA_AccF'
    LocalVarOutStrings(134) = 'FA_Hist'
    LocalVarOutStrings(135) = 'TRA_LastRefSpd'
    LocalVarOutStrings(136) = 'VS_RefSpeed'
    LocalVarOutStrings(137) = 'PtfmTDX'
    LocalVarOutStrings(138) = 'PtfmTDY'
    LocalVarOutStrings(139) = 'PtfmTDZ'
    LocalVarOutStrings(140) = 'PtfmRDX'
    LocalVarOutStrings(141) = 'PtfmRDY'
    LocalVarOutStrings(142) = 'PtfmRDZ'
    LocalVarOutStrings(143) = 'PtfmTVX'
    LocalVarOutStrings(144) = 'PtfmTVY'
    LocalVarOutStrings(145) = 'PtfmTVZ'
    LocalVarOutStrings(146) = 'PtfmRVX'
    LocalVarOutStrings(147) = 'PtfmRVY'
    LocalVarOutStrings(148) = 'PtfmRVZ'
    LocalVarOutStrings(149) = 'PtfmTAX'
    LocalVarOutStrings(150) = 'PtfmTAY'
    LocalVarOutStrings(151) = 'PtfmTAZ'
    LocalVarOutStrings(152) = 'PtfmRAX'
    LocalVarOutStrings(153) = 'PtfmRAY'
    LocalVarOutStrings(154) = 'PtfmRAZ'
    LocalVarOutStrings(155) = 'CC_DesiredL'
    LocalVarOutStrings(156) = 'CC_ActuatedL'
    LocalVarOutStrings(157) = 'CC_ActuatedDL'
    LocalVarOutStrings(158) = 'StC_Input'
    LocalVarOutStrings(159) = 'Flp_Angle'
    LocalVarOutStrings(160) = 'RootMyb_Last'
    LocalVarOutStrings(161) = 'ACC_INFILE_SIZE'
    LocalVarOutStrings(162) = 'AWC_complexangle'
    LocalVarOutStrings(163) = 'TiltMean'
    LocalVarOutStrings(164) = 'YawMean'
    LocalVarOutStrings(165) = 'ZMQ_ID'
    LocalVarOutStrings(166) = 'ZMQ_YawOffset'
    LocalVarOutStrings(167) = 'ZMQ_TorqueOffset'
    LocalVarOutStrings(168) = 'ZMQ_PitOffset'
    LocalVarOutStrings(169) = 'ZMQ_R_Speed'
    LocalVarOutStrings(170) = 'ZMQ_R_Torque'
    LocalVarOutStrings(171) = 'ZMQ_R_Pitch'
    ...
    IF ((LocalVar%iStatus == 0) .OR. (LocalVar%iStatus == -9))  THEN ! .TRUE. if we're on the first call to the DLL
        ...
        IF (CntrPar%LoggingLevel > 1) THEN
            ...
            WRITE(UnDb2, '(172(a20,TR5:))') 'Time',   LocalVarOutStrings
            WRITE(UnDb2, '(172(a20,TR5:))')
        END IF
    ...
    ! Write debug files
    FmtDat = "(F20.5,TR5,171(ES20.5E2,TR5:))"   ! The format of the debugging data
