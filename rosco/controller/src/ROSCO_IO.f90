...
SUBROUTINE WriteRestartFile(LocalVar, CntrPar, ErrVar, objInst, RootName, size_avcOUTNAME)
    ...
    ELSE
        ...
        WRITE( Un, IOSTAT=ErrStat) LocalVar%Alpha_ConstPower
        WRITE( Un, IOSTAT=ErrStat) LocalVar%Kp_Float
        WRITE( Un, IOSTAT=ErrStat) LocalVar%Kp_FloatTq
        ...
        WRITE( Un, IOSTAT=ErrStat) LocalVar%Fl_TqCom
        WRITE( Un, IOSTAT=ErrStat) LocalVar%NACIMU_FA_AccF
        WRITE( Un, IOSTAT=ErrStat) LocalVar%FA_AccF
        WRITE( Un, IOSTAT=ErrStat) LocalVar%NACIMU_FA_AccFTq
        WRITE( Un, IOSTAT=ErrStat) LocalVar%FA_AccFTq
...
SUBROUTINE ReadRestartFile(avrSWAP, LocalVar, CntrPar, objInst, PerfData, RootName, size_avcOUTNAME, ErrVar)
    ...
    ELSE
        ...
        READ( Un, IOSTAT=ErrStat) LocalVar%Alpha_ConstPower
        READ( Un, IOSTAT=ErrStat) LocalVar%Kp_Float
        READ( Un, IOSTAT=ErrStat) LocalVar%Kp_FloatTq
        ...
        READ( Un, IOSTAT=ErrStat) LocalVar%Fl_TqCom
        READ( Un, IOSTAT=ErrStat) LocalVar%NACIMU_FA_AccF
        READ( Un, IOSTAT=ErrStat) LocalVar%FA_AccF
        READ( Un, IOSTAT=ErrStat) LocalVar%NACIMU_FA_AccFTq
        READ( Un, IOSTAT=ErrStat) LocalVar%FA_AccFTq
...
! Debug routine, defines what gets printed to DEBUG.dbg if LoggingLevel = 1
    ...
    CHARACTER(15), DIMENSION(164)      :: LocalVarOutStrings
    ...
    DebugOutData(14) = DebugVar%NacIMU_FA_AccFTq
    DebugOutData(15) = DebugVar%FA_AccFTq
    DebugOutData(16) = DebugVar%Fl_PitCom
    DebugOutData(17) = DebugVar%Fl_TqCom
    DebugOutData(18) = DebugVar%PC_MinPit
    DebugOutData(19) = DebugVar%axisTilt_1P
    DebugOutData(20) = DebugVar%axisYaw_1P
    DebugOutData(21) = DebugVar%axisTilt_2P
    DebugOutData(22) = DebugVar%axisYaw_2P
    DebugOutData(23) = DebugVar%YawRateCom
    DebugOutData(24) = DebugVar%NacHeadingTarget
    DebugOutData(25) = DebugVar%NacVaneOffset
    DebugOutData(26) = DebugVar%Yaw_Err
    DebugOutData(27) = DebugVar%YawState
    DebugOutData(28) = DebugVar%VS_RefSpd
    DebugOutData(29) = DebugVar%PC_RefSpd
    DebugOutStrings = [CHARACTER(15) ::  'WE_Cp', 'WE_b', 'WE_w', 'WE_t', 'WE_Vm', & 
                                      'WE_Vt', 'WE_Vw', 'WE_lambda', 'PC_PICommand', 'GenSpeedF', & 
                                      'RotSpeedF', 'NacIMU_FA_AccF', 'FA_AccF', 'NacIMU_FA_AccFTq', 'FA_AccFTq', & 
                                      'Fl_PitCom', 'Fl_TqCom', 'PC_MinPit', 'axisTilt_1P', 'axisYaw_1P', & 
                                      'axisTilt_2P', 'axisYaw_2P', 'YawRateCom', 'NacHeadingTarget', 'NacVaneOffset', & 
                                      'Yaw_Err', 'YawState', 'VS_RefSpd', 'PC_RefSpd']
    DebugOutUnits = [CHARACTER(15) ::  '[-]', '[-]', '[-]', '[-]', '[m/s]', & 
                                      '[m/s]', '[m/s]', '[rad]', '[rad]', '[rad/s]', & 
                                      '[rad/s]', '[rad/s]', '[m/s]', '[rad/s]', '[m/s]', & 
                                      '[rad]', '[Nm]', '[rad]', '[N/A]', '[N/A]', & 
                                      '[N/A]', '[N/A]', '[rad/s]', '[deg]', '[deg]', & 
                                      '[deg]', '[N/A]', '[rad/s]', '[rad/s]']
    nLocalVars = 164
    ...
    LocalVarOutData(82) = LocalVar%Alpha_ConstPower
    LocalVarOutData(83) = LocalVar%Kp_Float
    LocalVarOutData(84) = LocalVar%Kp_FloatTq
    LocalVarOutData(85) = LocalVar%VS_MaxTq
    LocalVarOutData(86) = LocalVar%VS_LastGenTrq
    LocalVarOutData(87) = LocalVar%VS_LastGenPwr
    LocalVarOutData(88) = LocalVar%VS_MechGenPwr
    LocalVarOutData(89) = LocalVar%VS_SpdErrAr
    LocalVarOutData(90) = LocalVar%VS_SpdErrBr
    LocalVarOutData(91) = LocalVar%VS_SpdErr
    LocalVarOutData(92) = LocalVar%VS_State
    LocalVarOutData(93) = LocalVar%VS_Rgn3Pitch
    LocalVarOutData(94) = LocalVar%WE_Vw
    LocalVarOutData(95) = LocalVar%WE_Vw_F
    LocalVarOutData(96) = LocalVar%WE_VwI
    LocalVarOutData(97) = LocalVar%WE_VwIdot
    LocalVarOutData(98) = LocalVar%WE_Op
    LocalVarOutData(99) = LocalVar%WE_Op_Last
    LocalVarOutData(100) = LocalVar%VS_LastGenTrqF
    LocalVarOutData(101) = LocalVar%PRC_WSE_F
    LocalVarOutData(102) = LocalVar%PRC_R_Speed
    LocalVarOutData(103) = LocalVar%PRC_R_Torque
    LocalVarOutData(104) = LocalVar%PRC_R_Pitch
    LocalVarOutData(105) = LocalVar%PRC_R_Total
    LocalVarOutData(106) = LocalVar%PRC_Min_Pitch
    LocalVarOutData(107) = LocalVar%PS_Min_Pitch
    LocalVarOutData(108) = LocalVar%OL_Index
    LocalVarOutData(109) = LocalVar%SU_Stage
    LocalVarOutData(110) = LocalVar%SU_LoadStageStartTime
    LocalVarOutData(111) = LocalVar%SU_RotSpeedF
    LocalVarOutData(112) = LocalVar%SD_Trigger
    LocalVarOutData(113) = LocalVar%SD_BlPitchF
    LocalVarOutData(114) = LocalVar%SD_NacVaneF
    LocalVarOutData(115) = LocalVar%SD_GenSpeedF
    LocalVarOutData(116) = LocalVar%SD_Stage
    LocalVarOutData(117) = LocalVar%SD_StageStartTime
    LocalVarOutData(118) = LocalVar%SD_MaxPitchRate
    LocalVarOutData(119) = LocalVar%SD_MaxTorqueRate
    LocalVarOutData(120) = LocalVar%GenTq_SD
    LocalVarOutData(121) = LocalVar%Fl_PitCom
    LocalVarOutData(122) = LocalVar%Fl_TqCom
    LocalVarOutData(123) = LocalVar%NACIMU_FA_AccF
    LocalVarOutData(124) = LocalVar%FA_AccF
    LocalVarOutData(125) = LocalVar%NACIMU_FA_AccFTq
    LocalVarOutData(126) = LocalVar%FA_AccFTq
    LocalVarOutData(127) = LocalVar%FA_Hist
    LocalVarOutData(128) = LocalVar%TRA_LastRefSpd
    LocalVarOutData(129) = LocalVar%VS_RefSpeed
    LocalVarOutData(130) = LocalVar%PtfmTDX
    LocalVarOutData(131) = LocalVar%PtfmTDY
    LocalVarOutData(132) = LocalVar%PtfmTDZ
    LocalVarOutData(133) = LocalVar%PtfmRDX
    LocalVarOutData(134) = LocalVar%PtfmRDY
    LocalVarOutData(135) = LocalVar%PtfmRDZ
    LocalVarOutData(136) = LocalVar%PtfmTVX
    LocalVarOutData(137) = LocalVar%PtfmTVY
    LocalVarOutData(138) = LocalVar%PtfmTVZ
    LocalVarOutData(139) = LocalVar%PtfmRVX
    LocalVarOutData(140) = LocalVar%PtfmRVY
    LocalVarOutData(141) = LocalVar%PtfmRVZ
    LocalVarOutData(142) = LocalVar%PtfmTAX
    LocalVarOutData(143) = LocalVar%PtfmTAY
    LocalVarOutData(144) = LocalVar%PtfmTAZ
    LocalVarOutData(145) = LocalVar%PtfmRAX
    LocalVarOutData(146) = LocalVar%PtfmRAY
    LocalVarOutData(147) = LocalVar%PtfmRAZ
    LocalVarOutData(148) = LocalVar%CC_DesiredL(1)
    LocalVarOutData(149) = LocalVar%CC_ActuatedL(1)
    LocalVarOutData(150) = LocalVar%CC_ActuatedDL(1)
    LocalVarOutData(151) = LocalVar%StC_Input(1)
    LocalVarOutData(152) = LocalVar%Flp_Angle(1)
    LocalVarOutData(153) = LocalVar%RootMyb_Last(1)
    LocalVarOutData(154) = LocalVar%ACC_INFILE_SIZE
    LocalVarOutData(155) = LocalVar%AWC_complexangle(1)
    LocalVarOutData(156) = LocalVar%TiltMean
    LocalVarOutData(157) = LocalVar%YawMean
    LocalVarOutData(158) = LocalVar%ZMQ_ID
    LocalVarOutData(159) = LocalVar%ZMQ_YawOffset
    LocalVarOutData(160) = LocalVar%ZMQ_TorqueOffset
    LocalVarOutData(161) = LocalVar%ZMQ_PitOffset(1)
    LocalVarOutData(162) = LocalVar%ZMQ_R_Speed
    LocalVarOutData(163) = LocalVar%ZMQ_R_Torque
    LocalVarOutData(164) = LocalVar%ZMQ_R_Pitch
    ...
    LocalVarOutStrings(82) = 'Alpha_ConstPower'
    LocalVarOutStrings(83) = 'Kp_Float'
    LocalVarOutStrings(84) = 'Kp_FloatTq'
    LocalVarOutStrings(85) = 'VS_MaxTq'
    LocalVarOutStrings(86) = 'VS_LastGenTrq'
    LocalVarOutStrings(87) = 'VS_LastGenPwr'
    LocalVarOutStrings(88) = 'VS_MechGenPwr'
    LocalVarOutStrings(89) = 'VS_SpdErrAr'
    LocalVarOutStrings(90) = 'VS_SpdErrBr'
    LocalVarOutStrings(91) = 'VS_SpdErr'
    LocalVarOutStrings(92) = 'VS_State'
    LocalVarOutStrings(93) = 'VS_Rgn3Pitch'
    LocalVarOutStrings(94) = 'WE_Vw'
    LocalVarOutStrings(95) = 'WE_Vw_F'
    LocalVarOutStrings(96) = 'WE_VwI'
    LocalVarOutStrings(97) = 'WE_VwIdot'
    LocalVarOutStrings(98) = 'WE_Op'
    LocalVarOutStrings(99) = 'WE_Op_Last'
    LocalVarOutStrings(100) = 'VS_LastGenTrqF'
    LocalVarOutStrings(101) = 'PRC_WSE_F'
    LocalVarOutStrings(102) = 'PRC_R_Speed'
    LocalVarOutStrings(103) = 'PRC_R_Torque'
    LocalVarOutStrings(104) = 'PRC_R_Pitch'
    LocalVarOutStrings(105) = 'PRC_R_Total'
    LocalVarOutStrings(106) = 'PRC_Min_Pitch'
    LocalVarOutStrings(107) = 'PS_Min_Pitch'
    LocalVarOutStrings(108) = 'OL_Index'
    LocalVarOutStrings(109) = 'SU_Stage'
    LocalVarOutStrings(110) = 'SU_LoadStageStartTime'
    LocalVarOutStrings(111) = 'SU_RotSpeedF'
    LocalVarOutStrings(112) = 'SD_Trigger'
    LocalVarOutStrings(113) = 'SD_BlPitchF'
    LocalVarOutStrings(114) = 'SD_NacVaneF'
    LocalVarOutStrings(115) = 'SD_GenSpeedF'
    LocalVarOutStrings(116) = 'SD_Stage'
    LocalVarOutStrings(117) = 'SD_StageStartTime'
    LocalVarOutStrings(118) = 'SD_MaxPitchRate'
    LocalVarOutStrings(119) = 'SD_MaxTorqueRate'
    LocalVarOutStrings(120) = 'GenTq_SD'
    LocalVarOutStrings(121) = 'Fl_PitCom'
    LocalVarOutStrings(122) = 'Fl_TqCom'
    LocalVarOutStrings(123) = 'NACIMU_FA_AccF'
    LocalVarOutStrings(124) = 'FA_AccF'
    LocalVarOutStrings(125) = 'NACIMU_FA_AccFTq'
    LocalVarOutStrings(126) = 'FA_AccFTq'
    LocalVarOutStrings(127) = 'FA_Hist'
    LocalVarOutStrings(128) = 'TRA_LastRefSpd'
    LocalVarOutStrings(129) = 'VS_RefSpeed'
    LocalVarOutStrings(130) = 'PtfmTDX'
    LocalVarOutStrings(131) = 'PtfmTDY'
    LocalVarOutStrings(132) = 'PtfmTDZ'
    LocalVarOutStrings(133) = 'PtfmRDX'
    LocalVarOutStrings(134) = 'PtfmRDY'
    LocalVarOutStrings(135) = 'PtfmRDZ'
    LocalVarOutStrings(136) = 'PtfmTVX'
    LocalVarOutStrings(137) = 'PtfmTVY'
    LocalVarOutStrings(138) = 'PtfmTVZ'
    LocalVarOutStrings(139) = 'PtfmRVX'
    LocalVarOutStrings(140) = 'PtfmRVY'
    LocalVarOutStrings(141) = 'PtfmRVZ'
    LocalVarOutStrings(142) = 'PtfmTAX'
    LocalVarOutStrings(143) = 'PtfmTAY'
    LocalVarOutStrings(144) = 'PtfmTAZ'
    LocalVarOutStrings(145) = 'PtfmRAX'
    LocalVarOutStrings(146) = 'PtfmRAY'
    LocalVarOutStrings(147) = 'PtfmRAZ'
    LocalVarOutStrings(148) = 'CC_DesiredL'
    LocalVarOutStrings(149) = 'CC_ActuatedL'
    LocalVarOutStrings(150) = 'CC_ActuatedDL'
    LocalVarOutStrings(151) = 'StC_Input'
    LocalVarOutStrings(152) = 'Flp_Angle'
    LocalVarOutStrings(153) = 'RootMyb_Last'
    LocalVarOutStrings(154) = 'ACC_INFILE_SIZE'
    LocalVarOutStrings(155) = 'AWC_complexangle'
    LocalVarOutStrings(156) = 'TiltMean'
    LocalVarOutStrings(157) = 'YawMean'
    LocalVarOutStrings(158) = 'ZMQ_ID'
    LocalVarOutStrings(159) = 'ZMQ_YawOffset'
    LocalVarOutStrings(160) = 'ZMQ_TorqueOffset'
    LocalVarOutStrings(161) = 'ZMQ_PitOffset'
    LocalVarOutStrings(162) = 'ZMQ_R_Speed'
    LocalVarOutStrings(163) = 'ZMQ_R_Torque'
    LocalVarOutStrings(164) = 'ZMQ_R_Pitch'
    ...
    IF ((LocalVar%iStatus == 0) .OR. (LocalVar%iStatus == -9))  THEN ! .TRUE. if we're on the first call to the DLL
        ...
        IF (CntrPar%LoggingLevel > 1) THEN
            ...
            WRITE(UnDb2, '(165(a20,TR5:))') 'Time',   LocalVarOutStrings
            WRITE(UnDb2, '(165(a20,TR5:))')
        END IF
    ...
    ! Write debug files
    FmtDat = "(F20.5,TR5,164(ES20.5E2,TR5:))"   ! The format of the debugging data
