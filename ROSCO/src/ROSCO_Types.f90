...
TYPE, PUBLIC :: LocalVariables
    ...
    REAL(DbKi)                    :: PC_PitComC                  ! Collective pitch commmand from PI control [rad].
    REAL(DbKi)                    :: PC_PitComT                  ! Total command pitch based on the sum of PI and floating feedback [rad].
