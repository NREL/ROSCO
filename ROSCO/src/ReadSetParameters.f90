...
! -----------------------------------------------------------------------------------
    ...
    SUBROUTINE ReadControlParameterFileSub(CntrPar, zmqVar, accINFILE, accINFILE_size,ErrVar)!, accINFILE_size)
        ...
        CALL ParseInput(UnControllerParameters,CurLine,'Twr_ControlMode',accINFILE(1),CntrPar%Twr_ControlMode,ErrVar)
        ...
        CALL ParseInput(UnControllerParameters,CurLine,'Twr_Mode',accINFILE(1),CntrPar%Twr_Mode,ErrVar)
