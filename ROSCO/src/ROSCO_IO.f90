...
! Debug routine, defines what gets printed to DEBUG.dbg if LoggingLevel = 1
    ...
    LocalVarOutData(22) = LocalVar%VS_RefSpd
    LocalVarOutData(23) = LocalVar%PC_RefSpd
    ...
    LocalVarOutData(46) = LocalVar%axisTilt_1P
    LocalVarOutData(47) = LocalVar%axisYaw_1P
    LocalVarOutData(48) = LocalVar%axisYawF_1P
    LocalVarOutData(49) = LocalVar%axisTilt_2P
    LocalVarOutData(50) = LocalVar%axisYaw_2P
    LocalVarOutData(51) = LocalVar%axisYawF_2P
    LocalVarOutData(52) = LocalVar%IPC_KI(1)
    LocalVarOutData(53) = LocalVar%IPC_KP(1)
    LocalVarOutData(54) = LocalVar%IPC_IntSat
    LocalVarOutData(55) = LocalVar%PC_State
    LocalVarOutData(56) = LocalVar%PitCom(1)
    LocalVarOutData(57) = LocalVar%PitComAct(1)
    LocalVarOutData(58) = LocalVar%SS_DelOmegaF
    LocalVarOutData(59) = LocalVar%TestType
    LocalVarOutData(60) = LocalVar%VS_MaxTq
    LocalVarOutData(61) = LocalVar%VS_LastGenTrq
    LocalVarOutData(62) = LocalVar%VS_LastGenPwr
    LocalVarOutData(63) = LocalVar%VS_MechGenPwr
    LocalVarOutData(64) = LocalVar%VS_SpdErrAr
    LocalVarOutData(65) = LocalVar%VS_SpdErrBr
    LocalVarOutData(66) = LocalVar%VS_SpdErr
    LocalVarOutData(67) = LocalVar%VS_State
    LocalVarOutData(68) = LocalVar%VS_Rgn3Pitch
    LocalVarOutData(69) = LocalVar%WE_Vw
    LocalVarOutData(70) = LocalVar%WE_Vw_F
    LocalVarOutData(71) = LocalVar%WE_VwI
    LocalVarOutData(72) = LocalVar%WE_VwIdot
    LocalVarOutData(73) = LocalVar%VS_LastGenTrqF
    LocalVarOutData(74) = LocalVar%Fl_PitCom
    LocalVarOutData(75) = LocalVar%NACIMU_FA_AccF
    LocalVarOutData(76) = LocalVar%FA_AccF
    LocalVarOutData(77) = LocalVar%PtfmTDX
    LocalVarOutData(78) = LocalVar%PtfmTDY
    LocalVarOutData(79) = LocalVar%PtfmTDZ
    LocalVarOutData(80) = LocalVar%PtfmRDX
    LocalVarOutData(81) = LocalVar%PtfmRDY
    LocalVarOutData(82) = LocalVar%PtfmRDZ
    LocalVarOutData(83) = LocalVar%PtfmTVX
    LocalVarOutData(84) = LocalVar%PtfmTVY
    LocalVarOutData(85) = LocalVar%PtfmTVZ
    LocalVarOutData(86) = LocalVar%PtfmRVX
    LocalVarOutData(87) = LocalVar%PtfmRVY
    LocalVarOutData(88) = LocalVar%PtfmRVZ
    LocalVarOutData(89) = LocalVar%PtfmTAX
    LocalVarOutData(90) = LocalVar%PtfmTAY
    LocalVarOutData(91) = LocalVar%PtfmTAZ
    LocalVarOutData(92) = LocalVar%PtfmRAX
    LocalVarOutData(93) = LocalVar%PtfmRAY
    LocalVarOutData(94) = LocalVar%PtfmRAZ
    LocalVarOutData(95) = LocalVar%CC_DesiredL(1)
    LocalVarOutData(96) = LocalVar%CC_ActuatedL(1)
    LocalVarOutData(97) = LocalVar%CC_ActuatedDL(1)
    LocalVarOutData(98) = LocalVar%StC_Input(1)
    LocalVarOutData(99) = LocalVar%Flp_Angle(1)
    LocalVarOutData(100) = LocalVar%RootMyb_Last(1)
    LocalVarOutData(101) = LocalVar%ACC_INFILE_SIZE
    LocalVarOutData(102) = LocalVar%AWC_complexangle(1)
    LocalVarOutStrings = [CHARACTER(15) ::  'iStatus', 'Time', 'DT', 'VS_GenPwr', 'GenSpeed', & 
                                      ...
                                      'RotSpeedF', 'VS_RefSpd', 'PC_RefSpd', 'GenSpeedF', 'GenTq', & 
    ...
    IF ((LocalVar%iStatus == 0) .OR. (LocalVar%iStatus == -9))  THEN ! .TRUE. if we're on the first call to the DLL
        ...
        IF (CntrPar%LoggingLevel > 1) THEN
            ...
            WRITE(UnDb2, '(103(a20,TR5:))') 'Time',   LocalVarOutStrings
            WRITE(UnDb2, '(103(a20,TR5:))')
        END IF
    ...
    ! Write debug files
    FmtDat = "(F20.5,TR5,102(ES20.5E2,TR5:))"   ! The format of the debugging data
    IF(CntrPar%LoggingLevel > 0) THEN
