...
! Debug routine, defines what gets printed to DEBUG.dbg if LoggingLevel = 1
    ...
    LocalVarOutData(21) = LocalVar%VS_RefSpd
    LocalVarOutData(22) = LocalVar%PC_RefSpd
    LocalVarOutData(23) = LocalVar%GenSpeedF
    LocalVarOutData(24) = LocalVar%GenTq
    LocalVarOutData(25) = LocalVar%GenTqMeas
    LocalVarOutData(26) = LocalVar%GenArTq
    LocalVarOutData(27) = LocalVar%GenBrTq
    LocalVarOutData(28) = LocalVar%IPC_PitComF(1)
    LocalVarOutData(29) = LocalVar%PC_KP
    LocalVarOutData(30) = LocalVar%PC_KI
    LocalVarOutData(31) = LocalVar%PC_KD
    LocalVarOutData(32) = LocalVar%PC_TF
    LocalVarOutData(33) = LocalVar%PC_MaxPit
    LocalVarOutData(34) = LocalVar%PC_MinPit
    ...
    LocalVarOutData(45) = LocalVar%IPC_KI(1)
    LocalVarOutData(46) = LocalVar%IPC_KP(1)
    ...
    LocalVarOutStrings = [CHARACTER(15) ::  'iStatus', 'Time', 'DT', 'VS_GenPwr', 'GenSpeed', & 
                                      ...
                                      'VS_RefSpd', 'PC_RefSpd', 'GenSpeedF', 'GenTq', 'GenTqMeas', & 
                                      ...
                                      'IPC_AxisTilt_1P', 'IPC_AxisYaw_1P', 'IPC_AxisTilt_2P', 'IPC_AxisYaw_2P', 'IPC_KI', & 
                                      'IPC_KP', 'PC_State', 'PitCom', 'PitComAct', 'SS_DelOmegaF', & 
