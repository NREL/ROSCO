...
class FileProcessing():
    ...
    def write_param_file(self, param_file, turbine, controller, new_file=True):
        ...
        if new_file:
            ...
            file.write('\n')
            file.write('!------- DEBUG ------------------------------------------------------------\n')
            file.write('{}					! LoggingLevel		- {{0: write no debug files, 1: write standard output .dbg-file, 2: write standard output .dbg-file and complete avrSWAP-array .dbg2-file}}\n'.format(controller.LoggingLevel))
            file.write('\n')
            ...
            file.write('{:<014.5f}      ! VS_TSRopt			- Power-maximizing region 2 tip-speed-ratio [rad].\n'.format(turbine.Cp.TSR_opt))
            file.write('\n')
