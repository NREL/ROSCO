...
def main():
    ...
    parameter_filename = os.path.join(tune_dir,'NREL2p8.yaml')
    ...
    turbine.save(os.path.join(example_out_dir,'01_NREL2p8_saved.p'))

    # Now load the turbine and plot the Cp surface

    # Load quick from python pickle
    turbine = turbine.load(os.path.join(example_out_dir,'01_NREL2p8_saved.p'))
    ...
    if False:
        ...
        plt.savefig(os.path.join(example_out_dir,'01_NREL2p8_Cp.png'))
