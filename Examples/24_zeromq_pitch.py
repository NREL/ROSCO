'''
----------- 24_zeromq_pitch --------------
Run ROSCO using the ROSCO toolbox control interface and execute communication with ZeroMQ, now for pitch commands.
-------------------------------------

A demonstrator for ZeroMQ communication for pitch commands. Instead of using ROSCO with with control interface, 
...
def run_zmq():
    ...
    while connect_zmq:
        ...
        s.send_setpoints(bladePitch=pitch_command)
